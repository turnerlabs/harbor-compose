...
```
$ sudo curl -sSLo /usr/local/bin/harbor-compose https://github.com/turnerlabs/harbor-compose/releases/download/v0.13.1/ncd_darwin_amd64 &&  sudo chmod +x /usr/local/bin/harbor-compose
```
